...
import { FaArrowLeft, FaTrash, FaCar, FaCalendar, FaMapMarkerAlt, FaMoneyBillWave, FaCaretDown, FaMoon, FaSun, FaUpload, FaMicrophone, FaStop, FaCircle, FaTimes } from 'react-icons/fa';
...
const handleLogout = () => {
  ...
  const validateStep = (step) => {
    ...
    if (step === 1) {
      ...
      // VehicleMileage, RegistrationYear, VehiclePower, Transmission, Color are optional
      ...
      // Additional Details step validation - REQUIRED FIELDS
      if (!formData.SellerComment?.trim()) {
        errors.SellerComment = 'Description is required';
        console.log('SellerComment missing');
      }
      if (!formData.VehicleBodyTypeID) {
        errors.VehicleBodyTypeID = 'Body type is required';
...
const validateForm = () => {
  ...
  requiredFields.forEach(field => {
    ...
    if (['VehicleTypeID', 'VehicleBrandID', 'VehicleModelID'].includes(field.key)) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          {fieldErrors.VehicleTypeID && (
            <p className="text-sm text-red-500">{fieldErrors.VehicleTypeID}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {fieldErrors.VehicleBrandID && (
            <p className="text-sm text-red-500">{fieldErrors.VehicleBrandID}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          {fieldErrors.VehicleModelID && (
            <p className="text-sm text-red-500">{fieldErrors.VehicleModelID}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {fieldErrors.LocationName && (
            <p className="text-sm text-red-500">{fieldErrors.LocationName}</p>
          )}
        </div>
      </div>
  ...
  <div className="space-y-6">
    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
      ...
      {fieldErrors.EngineType && (
        <p className="text-sm text-red-500 mt-2">{fieldErrors.EngineType}</p>
      )}
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
        <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">
          {t.vehicleBodyType} <span className="text-red-500">*</span>
        </label>
        <select
        ...
        {fieldErrors.VehicleBodyTypeID && (
          <p className="text-sm text-red-500 mt-2">{fieldErrors.VehicleBodyTypeID}</p>
        )}
        {filterDataLoading && (
    ...
    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
      <label className="block text-sm font-medium mb-3 text-gray-700 dark:text-gray-300">
        {t.ownership} <span className="text-red-500">*</span>
      </label>
      ...
      {fieldErrors.Ownership && (
        <p className="text-sm text-red-500 mt-2">{fieldErrors.Ownership}</p>
      )}
    </div>

    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
      <label className="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">
        {t.sellerComment} <span className="text-red-500">*</span>
      </label>
      <textarea
        name="SellerComment"
      ...
      />
      {fieldErrors.SellerComment && (
        <p className="text-sm text-red-500 mt-2">{fieldErrors.SellerComment}</p>
      )}
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-2">
        ...
        {fieldErrors.VehicleCondition && (
          <p className="text-sm text-red-500 mt-2">{fieldErrors.VehicleCondition}</p>
        )}
      </div>
