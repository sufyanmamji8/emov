          ...
          >
            ...
            <div>
              ...
              <input 
                ...
                className={`w-full px-4 py-3 text-sm text-gray-900 border ${
                  fieldErrors.email ? 'border-red-500' : 'border-gray-200'
                } rounded-lg focus:ring-2 focus:ring-emov-purple focus:border-transparent focus:outline-none bg-gray-100 transition-colors duration-200`}
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 pr-10 text-sm text-gray-900 border ${
            ...
            <div className="text-right">
              <Link 
                to="/forgot-password" 
                className="text-sm font-medium text-emov-purple hover:text-emov-purple-dark transition-colors"
              >
                Forgot Password?
              </Link>
            </div>
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full px-4 py-3 rounded-lg text-white font-medium transition-all focus:outline-none disabled:opacity-70 disabled:cursor-not-allowed"
              style={{ 
