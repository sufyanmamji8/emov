...
const Signup = () => {
  ...
  return (
    <div className="h-screen bg-white flex overflow-hidden no-scrollbar">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 bg-white overflow-y-auto no-scrollbar">
        <div className="w-full max-w-md">
          ...
          <div className="w-full animate-fade-in flex flex-col items-center">
            ...
            <div className="text-center mb-4 w-full">
              ...
              <p className="text-xs text-gray-500">Join us and start your journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-4">
              {/* Full Name Field */}
              <div>
                <label className="block text-base font-normal text-gray-700 mb-1">Full Name</label>
                <input 
                  type="text" 
                  name="fullName"
                  ...
                  } rounded-lg focus:ring-2 focus:ring-emov-purple focus:border-transparent bg-white transition-all duration-300`}
              ...
              {/* Password Field */}
              <div>
                <label className="block text-base font-normal text-gray-700 mb-1">Password</label>
                <div className="relative">
                  <input 
                    ...
                    onChange={handleChange}
                    className={`w-full px-3 py-2.5 pr-10 text-base border ${
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 text-white text-base font-medium rounded-lg transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                style={{ 
